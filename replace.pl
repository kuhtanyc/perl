...
sub excelFormat() {
  ...
  my $outputdir ='C:\Documents and
Settings\kuhtad\Desktop\OLE\output.xls';
...
($name,$ssn,$dob,$phone,$misc)=split("\t",$line);
    ...
    #perform regexes on $name to eliminate specified
strings;
    #eliminate instances of "n/a","na","unknown","not
known",
        $name =~ s/na//g;
        $name =~ s/n\/a//g;
        $name =~ s/unknown//g;
    ...
    #perform regexes on $dob to eliminate specified
strings;
    #eliminate instances of "n/a","na","unknown","not
known",
        #repeating numbers (ie:
11111,22222,33333,etc...)
    ...
    #perform regexes on $misc to eliminate specified
strings;
    #eliminate instances of "n/a","na","unknown","not
known",
        #repeating numbers (ie:
